...
object WordLadder2 {
    ...
    fun findLadders(start: String, end: String, dict: List<String>): List<List<String>> {
        ...
        bfs(nodeStart)
        val solutionList = mutableListOf<List<String>>()
    ...
    private fun constructSolutions(endNode: DistNode, curSolution: MutableList<String>, solutionSet: MutableList<List<String>>) {
